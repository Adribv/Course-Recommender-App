...
const SignUp = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      // Redirect to profile setup on successful sign-up
    ...
    >
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: "url('https://images.unsplash.com/photo-1517842645767-c639042777db?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80')" 
          }}
        />
        ...
        <div className="relative z-10 flex flex-col justify-center px-12">
          ...
          >
            <h2 className="text-4xl font-bold mb-6 text-white">Begin Your Learning Journey</h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Sign up to access personalized learning</p>
          </div>
